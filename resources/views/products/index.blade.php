                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <form action="{{ route('products.index') }}" class="form-inline search-form">
                            ...
                            <div class="mt-sm-3">
                                ...
                                <a class="all-products" href="{{ route('products.index') }}">全部结果</a> &gt;
                                <!-- 如果当前是通过类目筛选的 -->
                                @if($category)
                    ...
                    <div class="filters">
                        ...
                        @if ($category && $category->is_directory)
                            <div class="row">
                                <div class="col-xs-3 filter-key">类目：</div>
                        ...
                        @foreach($products as $product)
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 product-item">
                                <div class="product-content">
                                    <div class="top">
                                        <div class="img"><a href="{{ route('products.show', ['product' => $product->id]) }}"><img src="{{ $product->image_url }}" alt="{{ $product->title }}"></a></div>
