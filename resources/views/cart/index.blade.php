                            ...
                            <div class="form-group">
                                ...
                                <div class="control-label">
                                    <div class="col-sm-4" style="display: inline-block; vertical-align:top">
                                        ...
                                        <span class="help-block" id="coupon_desc" role="alert"></span>
                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.btn-remove').click(function () {
                ...
                // closest() 方法可以获取到匹配选择器的第一个祖元素，在这里就是当前点击的 移除 按钮之上的 <tr> 标签
                ...
                swal({
                    ...
                    // 用户点击确定按钮，willDelete 的值就会是 true，否则为 false
                    if (!willDelete) {
                        return;
                    }
            ...
            $('#select-all').change(function () {
                // 获取单选框的选中状态
                // prop() 方法可以只掉标签中是否包含某个属性，当单选框被勾选时，对应的标签就会新增一个 checked 的属性
            ...
            $('.btn-create-order').click(function () {
                ...
                // 遍历<table> 标签内所有带有 data-id 属性的t <tr> 标签，也就是每一个购物车中的商品 SKU
