                        ...
                        <div class="order-summary text-right">
                            ...
                            @if(!$order->paid_at && !$order->closed)
                                <div class="payment-buttons">
                                    <a class="btn btn-primary btn-sm" href="{{ route('payment.ali_pay', ['order' => $order->id]) }}">支付宝支付</a>
                                    <!-- 把之前的微信支付按钮换成这个 -->
                                    <button class="btn btn-sm btn-success" id='btn-wechat'>微信支付</button>
                                    <!-- 分期支付按钮开始 -->
                                    <!-- 仅当订单总额大于分期最低金额时才展示分期按钮 -->
                            ...
                            @endif
                            <!-- 订单已支付，且退款状态不是未退款时展示退款信息 不是众筹订单，已支付，且退款状态是未退款时展示申请退款按钮 -->
        ...
        $(document).ready(function () {
            ...
            $('#btn-wechat').click(function () {
                swal({
                    ...
                    content: $('<img src="{{ route('payment.wechat_pay', ['order' => $order->id]) }}" />')[0],
